...
void cmd_min_print_help(void)
{
    mh_msg_fmt_req(
	    "min [-3|--3d] -k|--k=<k>\n"
	    "min [-3|--3d] -x|--k-x=<kx> -y|--k-y=<ky> [-t|--k-t=<kt>]\n"
	    "\n"
...
int cmd_min(int argc, char *argv[])
{
	...
	for (;;)
	{
	    ...
	    cvl_min3d(new_frame, framebuf, kx.value, ky.value, kt.value);
    	...
    	while (!cvl_error())
	{
	    ...
	    cvl_min(new_frame, frame, kx.value, ky.value);
