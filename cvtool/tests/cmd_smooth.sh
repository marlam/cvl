...
$CVTOOL smooth average -3 -k 1 < rgb.pnm > x123.pnm 
cmp 123.pnm x123.pnm 

# 2. median
$CVTOOL smooth median -3 -k 1 < rgb.pnm > xrgb.pnm 
cmp rgb.pnm xrgb.pnm 

# 3. gauss
$CVTOOL smooth gauss -x 1 -y 2 -t 3 --sigma-x=0.5 --sigma-y=1.0 --sigma-t=1.5 < rgb.pnm > /dev/null 
