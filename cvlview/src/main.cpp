...
static void cvlview_print_version(void)
{
...
static void cvlview_print_help(void)
{
...
static void cvlview_exceptional_exception(void)
{
...
int main(int argc, char *argv[])
{
    ...
    std::set_unexpected(cvlview_exceptional_exception);
    std::set_terminate(cvlview_exceptional_exception);

    QApplication *app = new QApplication(argc, argv);

    mh_option_info_t version = { false, cvlview_print_version };
    mh_option_info_t help = { false, cvlview_print_help };
    mh_option_t options[] = 
    { 
