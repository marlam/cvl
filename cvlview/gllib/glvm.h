...
namespace glvm
{
    ...
    inline bool equal(const float a, const float b, const int max_ulps = 0)
    {
        bool result;
    ...
    inline bool equal(const double a, const double b, const int max_ulps = 0)
    {
        bool result;
    ...
    inline bool equal(const long double a, const long double b, const int max_ulps = 0)
    {
        bool result;
    ...
    inline bool notEqual(const float a, const float b, const int max_ulps = 0)
    {
        return !glvm::equal(a, b, max_ulps);
    }

    inline bool notEqual(const double a, const double b, const int max_ulps = 0)
    {
        return !glvm::equal(a, b, max_ulps);
    }

    inline bool notEqual(const long double a, const long double b, const int max_ulps = 0)
    {
        return !glvm::equal(a, b, max_ulps);
    }
